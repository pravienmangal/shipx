                    ...
                    <div className="text-center">
                      <div className="row">
                        <div className="col text-white">
                          <h2 className="m-b-0 text-white font-w700">$2.4</h2>
                          <span>per unit</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="card-body">
                  <div className="profile-statistics">
                    <div className="text-center">
                      <div className="row">
                        <div className="col text-white">
                          <h3 className="m-b-0 text-white">$3.2</h3>
                          <span>Air</span>
                        </div>
                        <div className="col text-white">
                          <h3 className="m-b-0 text-white">$2.3</h3>{" "}
                          <span>Sea</span>
                        </div>
                        <div className="col text-white">
                          <h3 className="m-b-0 text-white">$1.2</h3>{" "}
                          <span>Ground</span>
                        </div>
                      </div>
                    </div>
        ...
        <div className="col-xl-5">
          <div className="row">
            <div className="col-lg-12">
              <div className="card">
                <div className="card-header">
                  <div className="card-title h5">Dimensions & Weight</div>
                </div>
                <div className="card-body">
                  <div className="profile-statistics">
                    <div className="text-center">
